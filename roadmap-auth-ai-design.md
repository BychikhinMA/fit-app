...
- Ориентир — Apple HIG.
- Отдельная задача — убрать узнаваемый «след ИИ»: одинаковые серые
  карточки подряд, пояснительный абзац мелким шрифтом под каждой цифрой.

### Баги

- В библиотеке упражнений можно подсветить несколько чипов группы мышц
  одновременно, хотя фильтр применяется только один.
